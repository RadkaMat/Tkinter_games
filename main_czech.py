...
okno.iconphoto(False, PhotoImage(file='icon.png'))

obrazek_na_pozadi = PhotoImage(file='bg_meadow.png')
...
def hra():
    ...
    or hadani.upper() in tajne_slovo:
        ...
        global obrazek
        obrazek = PhotoImage(file=f"hang_{7 - int(zivoty_pocet['text'])}.png")
...
obrazek_tlacitko = PhotoImage(file='button.png')
...
obrazek = PhotoImage(file='hang_0.png')
